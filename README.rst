...
NumPy_ and SciPy_ have support for this algorithm, but using it is an ordeal for the basic case. Also, the output does not include the commonly used "correlation coefficient".
